        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsultationFee = table.Column<decimal>(type: "decimal(12,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    CreatedByUserId1 = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_CreatedByUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerifiedPatient = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalRecords_Doctors_CreatedByDoctorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_CreatedByUserId1",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorAvailabilities_DoctorId_StartTs_EndTs",
                table: "DoctorAvailabilities",
                columns: new[] { "DoctorId", "StartTs", "EndTs" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_AverageRating_RatingCount",
                table: "Doctors",
